...
const retrieveGroupMessages =  require("../../../src/client/model/chat-functions")
jest.mock("../../../mocks/chat-function")

describe("retrieve messages with group ID of 1", ()=>{

    test('retrieve message given group ID 1', ()=>{
        let messageArray = []
...
describe("retrieve messages with group ID of 3", async ()=>{

    test('retrieve message given group ID 3', ()=>{
    let messageArray = []
    const dummyDate = new Date(2018,11,24,10,33)
