...
class Polling$2 extends Transport$1 {
  ...
  onData(data) {
    ...
    parser$3.decodePayload(data, this.socket.binaryType).forEach(callback); // if an event did not trigger closing
...
const debug$3 = browser.exports("engine.io-client:websocket"); // detect ReactNative environment
...
class Socket$2 extends Emitter$1 {
  ...
  open() {
    ...
    if (this.opts.rememberUpgrade && Socket$2.priorWebsocketSuccess && this.transports.indexOf("websocket") !== -1) {
      transport = "websocket";
...
Object.defineProperty(typedEvents, "__esModule", {
  value: true
});
...
class Socket extends typed_events_1$1.StrictEventEmitter {
  ...
  subEvents() {
    if (this.subs) return;
    const io = this.io;
    this.subs = [on_1$1.on(io, "open", this.onopen.bind(this)), on_1$1.on(io, "packet", this.onpacket.bind(this)), on_1$1.on(io, "error", this.onerror.bind(this)), on_1$1.on(io, "close", this.onclose.bind(this))];
  }
  /**
